export default class Player {
    ...
    run(gameSpeed, frameTimeDelta) {
        if (this.walkAnimationTimer <= 0 && !this.jumpInProgress) {
            this.currentAnimationFrame = (this.currentAnimationFrame + 1) % this.dinoRunImages.length;
            this.image = this.dinoRunImages[this.currentAnimationFrame];
